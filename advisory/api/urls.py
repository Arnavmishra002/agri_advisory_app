...
from .views import CropAdvisoryViewSet, TrendingCropsViewSet, CropViewSet, SMSIVRViewSet, PestDetectionViewSet, UserViewSet, TextToSpeechViewSet, ForumPostViewSet, LocationRecommendationViewSet, RealTimeGovernmentDataViewSet, DiagnosticViewSet
...
from .views_v3 import (
    WeatherViewSet, MarketPricesViewSet, ChatbotViewSet as ChatbotViewSetV3,
    GovernmentSchemesViewSet, IoTBlockchainViewSet
)
...
router.register(r'schemes', GovernmentSchemesViewSet, basename='schemes') # Updated basename
router.register(r'chatbot', ChatbotViewSetV3, basename='chatbot') # Using V3
