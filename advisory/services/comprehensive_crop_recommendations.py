    ...
    def _load_crop_database(self) -> Dict[str, Dict]:
        ...
        return {
            ...
            'bajra': {
                ...
                'soil_type': 'sandy', 'water_requirement': 'low', 'temperature_range': '25-35°C',
                'government_support': 'MSP', 'market_demand': 'Medium', 'profitability': 'Medium'
            },
            'ragi': {
            ...
            'chickpea': {
                ...
                'soil_type': 'loamy', 'water_requirement': 'low', 'temperature_range': '15-25°C',
            ...
            'potato': {
                ...
                'soil_type': 'sandy_loam', 'water_requirement': 'moderate', 'temperature_range': '15-25°C',
            ...
            'onion': {
                ...
                'soil_type': 'sandy_loam', 'water_requirement': 'moderate', 'temperature_range': '15-30°C',
            ...
            'strawberry': {
                ...
                'soil_type': 'loamy', 'water_requirement': 'high', 'temperature_range': '10-25°C',
                'government_support': 'Low', 'market_demand': 'High', 'profitability': 'Very High'
            },
            'kiwi': {
            ...
            'coconut': {
                ...
                'soil_type': 'sandy', 'water_requirement': 'high', 'temperature_range': '20-35°C',
                'government_support': 'Low', 'market_demand': 'High', 'profitability': 'Very High'
            },
            'cashew': {
                ...
                'soil_type': 'sandy', 'water_requirement': 'moderate', 'temperature_range': '20-35°C',
                'government_support': 'Low', 'market_demand': 'High', 'profitability': 'Very High'
            },
            'almond': {
            ...
            'cotton': {
                ...
                'soil_type': 'black', 'water_requirement': 'moderate', 'temperature_range': '20-35°C',
                'government_support': 'MSP', 'market_demand': 'High', 'profitability': 'High'
            },
            'sugarcane': {
                ...
                'soil_type': 'clay', 'water_requirement': 'high', 'temperature_range': '25-35°C',
                'government_support': 'High MSP', 'market_demand': 'High', 'profitability': 'High'
            },
            'jute': {
            ...
            'aloe_vera': {
                ...
                'soil_type': 'sandy', 'water_requirement': 'low', 'temperature_range': '20-35°C',
                'government_support': 'Low', 'market_demand': 'High', 'profitability': 'Very High'
            },
            'tulsi': {
            ...
            'ashwagandha': {
                ...
                'profit_per_hectare': 200000, 'export_potential': 'High', 'volatility': 'Medium',
                'soil_type': 'loamy', 'water_requirement': 'low', 'temperature_range': '15-30°C',
                'government_support': 'Low', 'market_demand': 'High', 'profitability': 'Very High'
            },
            'neem': {
        ...
        try:
            ...
            try:
                ...
                if weather_data and 'weather' in weather_data:
                    return {
                        'current_temperature': weather_data['weather'].get('temperature', f"{random.randint(20, 35)}°C"),
            ...
            try:
                ...
                if weather_data:
                    return {
                        'current_temperature': weather_data.get('temperature', f"{random.randint(20, 35)}°C"),
